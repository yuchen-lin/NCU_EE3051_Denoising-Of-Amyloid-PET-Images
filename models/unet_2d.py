...
def model(h, w, OUTPUT_CHANNELS):
    ...
    x = tf.keras.layers.Conv2D(filters=16,kernel_size=3,strides=1,padding='same',kernel_initializer=initializer)(x)
    ...
    x = tf.keras.layers.Conv2D(filters=OUTPUT_CHANNELS,kernel_size=1,strides=1,padding='same',kernel_initializer=initializer)(x)
